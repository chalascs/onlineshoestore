                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-12 text-center" id="carttable">
                        <table class="table table-responsive table-condensed" id="table-cart">
                            ...
                            %>
                            <tr>
                                <td class="text-center" colspan="6" style="font-family:Helvetica,Arial,sans-serif">Your cart is empty</td> 
                            </tr>
                            <%} else {
                            ...
                            <tr>
                                ...
                                <td class="text-right"><input type="number" id="abc" onchange="changeQTY(this.value + '-<%=ii%>')"></td>
                                <td id="cartTortel<%=ii%>" class="text-right"></td>
                            </tr>
                            <%}
                                }%>
                        </table>
